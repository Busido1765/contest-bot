...
var Ue = (s, e, t) => e in s ? We(s, e, { enumerable: true, configurable: true, writable: true, value: t }) : s[e] = t;
...
var V = class _V extends Error {
  constructor(e, t, n) {
    super(t, { cause: n }), this.type = e, Object.setPrototypeOf(this, _V.prototype);
  }
};
function f(s, e, t) {
  return new V(s, e, t);
}
var je = "ERR_METHOD_UNSUPPORTED";
var ze = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var Fe = "ERR_UNKNOWN_ENV";
var Je = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var Qe = "ERR_TIMED_OUT";
var Ye = "ERR_UNEXPECTED_TYPE";
var ce = "ERR_PARSE";
var Ze = "ERR_NAVIGATION_LIST_EMPTY";
var Ke = "ERR_NAVIGATION_CURSOR_INVALID";
var Xt = "ERR_NAVIGATION_ITEM_INVALID";
var es = "ERR_SSR_INIT";
var Xe = "ERR_INVALID_PATH_BASE";
function E() {
...
var ut = class {
  ...
  set(e, t) {
    Object.entries(typeof e == "string" ? { [e]: t } : e).reduce((r, [i, o]) => this.state[i] === o || o === void 0 ? r : (this.state[i] = o, this.ee.emit(`change:${i}`, o), true), false) && this.ee.emit("change", this.state);
  }
  /**
...
var lt = class extends Z {
  constructor(t, n, r) {
    ...
    c(this, "on", (t2, n2) => t2 === "click" ? w("back_button_pressed", n2) : this.state.on(t2, n2));
    c(this, "off", (t2, n2) => t2 === "click" ? B("back_button_pressed", n2) : this.state.off(t2, n2));
    this.postEvent = r;
  }
  set isVisible(t) {
...
var Ee = S((s) => s instanceof Date ? s : new Date(y().parse(s) * 1e3), "Date");
function K(s, e) {
  return new D((t) => {
...
var is = l(
  ...
  ({
    postEvent: s,
    state: e = { isConfirmationNeeded: false }
...
var hs = l(
  ({ version: s, postEvent: e }) => new Nt(false, s, e)
);
var Vt = class extends Y {
  constructor({ postEvent: t, ...n }) {
    super(n);
    c(this, "postEvent");
    c(this, "on", (t2, n2) => t2 === "click" ? w("main_button_pressed", n2) : this.state.on(t2, n2));
    c(this, "off", (t2, n2) => t2 === "click" ? B("main_button_pressed", n2) : this.state.off(t2, n2));
    this.postEvent = t;
  }
  /**
...
var Bt = class extends P {
  constructor({ postEvent: t, createRequestId: n, version: r, botInline: i, ...o }) {
    ...
    this.supports = (p) => a(p) ? p !== "switchInlineQuery" || i : false, this.supportsParam = Ve(r, {
...
var ds = l(
  ({ postEvent: s, version: e }) => new $t(false, e, s)
);
...
var _s = l(
  ({ version: s, postEvent: e }) => new Wt(false, s, e)
);
var Ut = class extends Z {
  constructor(t, n, r) {
    ...
    c(this, "on", (t2, n2) => t2 === "click" ? w("settings_button_pressed", n2) : this.state.on(t2, n2));
    c(this, "off", (t2, n2) => t2 === "click" ? B("settings_button_pressed", n2) : this.state.off(t2, n2));
    this.postEvent = r;
  }
  set isVisible(t) {
...
var gs = l(
  ...
  ({
    postEvent: s,
    state: e = { isVerticalSwipeEnabled: true },
    version: t
...
function Ps(s = true) {
  ...
  return A("iframe_ready", { reload_supported: true }), t;
}
function xs() {
...
async function Cs() {
  if (de(window))
    return true;
  try {
    return await d({ method: "web_app_request_theme", event: "theme_changed", timeout: 100 }), true;
  } catch {
    return false;
  }
}
...
var Ft = class {
   ...
   */
  attach() {
    this.attached || (this.attached = true, this.sync(), w("back_button_pressed", this.back));
  }
  /**
   ...
   */
  detach() {
    this.attached = false, B("back_button_pressed", this.back);
  }
  /**
...
var Le = class {
  constructor(e, t, { postEvent: n, hashMode: r = "classic", base: i } = {}) {
    ...
    c(this, "base");
    c(this, "attached", false);
    c(this, "onPopState", ({ state: e2 }) => {
      if (e2 === null)
        return this.push(this.parsePath(window.location.href));
      e2 === ie ? window.history.forward() : e2 === U && this.back(), e2 === H && this.forward();
    });
